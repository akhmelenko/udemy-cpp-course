...
##
## Debug
ProjectName            :=SmartPointers_UniquePointers
ConfigurationName      :=Debug
WorkspacePath          :=D:/cpp_projects/Section17_SmartPointers
ProjectPath            :=D:/cpp_projects/Section17_SmartPointers/SmartPointers_UniqPointers
...
ObjectsFileList        :="SmartPointers_UniquePointers.txt"
PCHCompileFlags        :=
...
$(IntermediateDirectory)/main.cpp$(ObjectSuffix): main.cpp
	...
	$(CXX) $(IncludePCH) $(SourceSwitch) "D:/cpp_projects/Section17_SmartPointers/SmartPointers_UniqPointers/main.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/Account.cpp$(ObjectSuffix): Account.cpp
	...
	$(CXX) $(IncludePCH) $(SourceSwitch) "D:/cpp_projects/Section17_SmartPointers/SmartPointers_UniqPointers/Account.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Account.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/Account_Util.cpp$(ObjectSuffix): Account_Util.cpp
	...
	$(CXX) $(IncludePCH) $(SourceSwitch) "D:/cpp_projects/Section17_SmartPointers/SmartPointers_UniqPointers/Account_Util.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Account_Util.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/CheckingAccount.cpp$(ObjectSuffix): CheckingAccount.cpp
	...
	$(CXX) $(IncludePCH) $(SourceSwitch) "D:/cpp_projects/Section17_SmartPointers/SmartPointers_UniqPointers/CheckingAccount.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/CheckingAccount.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/I_Printable.cpp$(ObjectSuffix): I_Printable.cpp
	...
	$(CXX) $(IncludePCH) $(SourceSwitch) "D:/cpp_projects/Section17_SmartPointers/SmartPointers_UniqPointers/I_Printable.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/I_Printable.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/TrustAccount.cpp$(ObjectSuffix): TrustAccount.cpp
	...
	$(CXX) $(IncludePCH) $(SourceSwitch) "D:/cpp_projects/Section17_SmartPointers/SmartPointers_UniqPointers/TrustAccount.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/TrustAccount.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/SavingsAccount.cpp$(ObjectSuffix): SavingsAccount.cpp
	...
	$(CXX) $(IncludePCH) $(SourceSwitch) "D:/cpp_projects/Section17_SmartPointers/SmartPointers_UniqPointers/SavingsAccount.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/SavingsAccount.cpp$(ObjectSuffix) $(IncludePath)
