...
##
## Debug
ProjectName            :=SmartPointers_SharedPointers
ConfigurationName      :=Debug
WorkspacePath          :=D:/cpp_projects/Section17_SmartPointers
ProjectPath            :=D:/cpp_projects/Section17_SmartPointers/SmartPointers_SharedPointers
...
ObjectsFileList        :="SmartPointers_SharedPointers.txt"
PCHCompileFlags        :=
...
$(IntermediateDirectory)/main.cpp$(ObjectSuffix): main.cpp
	...
	$(CXX) $(IncludePCH) $(SourceSwitch) "D:/cpp_projects/Section17_SmartPointers/SmartPointers_SharedPointers/main.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/Account.cpp$(ObjectSuffix): Account.cpp
	...
	$(CXX) $(IncludePCH) $(SourceSwitch) "D:/cpp_projects/Section17_SmartPointers/SmartPointers_SharedPointers/Account.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Account.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/Account_Util.cpp$(ObjectSuffix): Account_Util.cpp
	...
	$(CXX) $(IncludePCH) $(SourceSwitch) "D:/cpp_projects/Section17_SmartPointers/SmartPointers_SharedPointers/Account_Util.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Account_Util.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/TrustAccount.cpp$(ObjectSuffix): TrustAccount.cpp
	...
	$(CXX) $(IncludePCH) $(SourceSwitch) "D:/cpp_projects/Section17_SmartPointers/SmartPointers_SharedPointers/TrustAccount.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/TrustAccount.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/CheckingAccount.cpp$(ObjectSuffix): CheckingAccount.cpp
	...
	$(CXX) $(IncludePCH) $(SourceSwitch) "D:/cpp_projects/Section17_SmartPointers/SmartPointers_SharedPointers/CheckingAccount.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/CheckingAccount.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/I_Printable.cpp$(ObjectSuffix): I_Printable.cpp
	...
	$(CXX) $(IncludePCH) $(SourceSwitch) "D:/cpp_projects/Section17_SmartPointers/SmartPointers_SharedPointers/I_Printable.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/I_Printable.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/SavingsAccount.cpp$(ObjectSuffix): SavingsAccount.cpp
	...
	$(CXX) $(IncludePCH) $(SourceSwitch) "D:/cpp_projects/Section17_SmartPointers/SmartPointers_SharedPointers/SavingsAccount.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/SavingsAccount.cpp$(ObjectSuffix) $(IncludePath)
